...
import com.juaracoding.hadir.repository.ShiftingRepo;
...
public class ShiftingPage {
    ...
    public void setSearch(String value) {
        ...
        // WebElement inputNama = wait.until(ExpectedConditions.elementToBeClickable(searchBox));
        // inputNama.clear();
        // inputNama.sendKeys(value);
    }
    ...
    WebElement row = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//tr[td/h6[normalize-space(text())='" + nama + "']]")));
    ...
    WebElement hapusBtn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[contains(@class,'MuiMenuItem-root') and normalize-space(text())='Delete']")));
    ...
    public void clickYaConfirm() {
        WebElement clickYaButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(@class,'MuiButton-containedPrimary') and normalize-space(text())='Ya']")));
        clickYaButton.click();
    }
...
// ========================= getMassageError =========================
    ...
    WebElement errorElement = wait.until(
        ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//p[contains(@class,'MuiFormHelperText-root') and text()='Jam masuk harus diisi!']")
        )
    );
